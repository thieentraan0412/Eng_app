...
| `07-viet` | `index` danh sách có chỉ số / lọc / tìm kiếm / sắp xếp → `soan-thao` **chế độ tập trung toàn màn hình**: thanh định dạng + phím tắt, tự lưu, gạch chân chính tả nét sóng, panel trợ lý 4 tab (Chính tả · Câu · Gợi ý · Thống kê), popover gợi ý từ tại con trỏ, bảng **Hiển thị** (chiều rộng · kiểu chữ · cỡ chữ · giãn dòng, nhớ bằng localStorage); mobile: trợ lý thành bottom sheet đóng sẵn + nút nổi |
